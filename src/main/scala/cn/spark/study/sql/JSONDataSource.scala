...
object JSONDataSource {
    ...
    def main(args: Array[String]): Unit = {
        ...
        // 创建学生成绩DataFrame
        val studentScoresDF = sqlContext.read.json("hdfs://hadoop.zhengzhou.com:8020/spark-study/students.json")
        ...
        goodStudentsDF.write.format("json").save("hdfs://hadoop.zhengzhou.com:8020/spark-study/good-students-scala")
    }
