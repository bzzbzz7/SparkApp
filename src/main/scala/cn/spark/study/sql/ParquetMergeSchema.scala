...
object ParquetMergeSchema {
    ...
    def main(args: Array[String]): Unit = {
        ...
        studentsWithNameAgeDF.write.mode(SaveMode.Append).format("parquet").save("./students")
        ...
        studentsWithNameGradeDF.write.mode(SaveMode.Append).format("parquet").save("./students")
        ...
        val students = sqlContext.read.option("mergeSchema", "true").parquet("./students")
